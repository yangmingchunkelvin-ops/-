...
ANTHROPIC_KEY   = os.environ["ANTHROPIC_API_KEY"]  # Claude API Key
...
<div class="wrapper">
  ...
  <div class="footer">
    本邮件由 GitHub Actions + Claude API 自动生成<br>
